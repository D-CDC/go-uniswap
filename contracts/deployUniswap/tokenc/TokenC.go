...
// DeployTokenc deploys a new Ethereum contract, binding an instance of Tokenm to it.
func DeployTokenc(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *Tokenm, error) {
...
// NewTokenc creates a new instance of Tokenm, bound to a specific deployed contract.
func NewTokenc(address common.Address, backend bind.ContractBackend) (*Tokenm, error) {
